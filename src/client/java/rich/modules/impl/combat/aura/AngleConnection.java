...
public class AngleConnection implements IMinecraft {
   ...
   public void rotateTo(Angle.VecRotation var1, LivingEntity var2, int var3, AngleConfig var4, TaskPriority var5, ModuleStructure var6) {
      ...
      if (var1 == null) {
         if (this.currentAngle != null && this.returning) {
            ...
            if (var12 < 0.5) {
               ...
               var5 += 0.4F * var6;
               float var7 = MathHelper.wrapDegrees(var10.getYaw() - this.currentAngle.getYaw());
               float var8 = this.currentAngle.getYaw() + var7 * var5;
               float var9 = MathHelper.lerp(var5, this.currentAngle.getPitch(), var10.getPitch());
   ...
   private Vec3d fixVelocity(Vec3d var1, Vec3d var2, float var3) {
      if (this.currentAngle != null) {
         ...
         return new Vec3d(
            var7.getX() * var9 - var7.getZ() * var8, var7.getY(), var7.getZ() * var9 + var7.getX() * var8
         );
      } else {
         return var1;
      }
   ...
   public void onPacket(PacketEvent var1) {
      if (!var1.isCancelled()) {
         ...
         switch (var4) {
            case PlayerMoveC2SPacket var2 when var2.changesLook():
               this.serverAngle = new Angle(var2.getYaw(1.0F), var2.getPitch(1.0F));
               break;
            case PlayerPositionLookS2CPacket var6:
               PlayerPositionLookS2CPacket var3 = (PlayerPositionLookS2CPacket)var4;
               this.serverAngle = new Angle(var3.change().yaw(), var3.change().pitch());
               break;
            default:
         }
      }
