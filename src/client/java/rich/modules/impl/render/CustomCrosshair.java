...
public class CustomCrosshair extends ModuleStructure {
      ...
      if (this.isState() && mc.player != null && mc.world != null) {
         if (mc.currentScreen == null) {
            if (mc.options.getPerspective() == Perspective.FIRST_PERSON) {
               ...
               int var6 = ColorUtil.h(this.color.getColor(), (int)this.alpha.getValue());
               if (var5.circle) {
   ...
   private void drawCross(DrawContext var1, float var2, float var3, CustomCrosshair.CrosshairConfig var4, int var5, boolean var6) {
   ...
   public boolean shouldReplaceVanillaCrosshair() {
      return this.isState() && mc.player != null && mc.world != null && mc.currentScreen == null;
   }

   private record CrosshairConfig(float size, float gap, float thickness, boolean circle, boolean outline, boolean tShape) {
   }
}
