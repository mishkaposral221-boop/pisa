...
public class WorldParticles extends ModuleStructure {
   ...
   public void onTick(TickEvent var1) {
      if (mc.player != null && mc.world != null) {
         ...
         if (this.lastPlayerPos != Vec3d.ZERO) {
            this.playerVelocity = var2.subtract(this.lastPlayerPos);
   ...
   public void onWorldRender(WorldRenderEvent var1) {
      if (!this.particles.isEmpty()) {
         ...
         MatrixStack var3 = var1.getStack();
         Vec3d var4 = mc.gameRenderer.getCamera().getCameraPos();
         long var5 = System.currentTimeMillis();
         float var7 = (float)(var5 % 9000L) / 9000.0F * 360.0F;
         float var8 = mc.gameRenderer.getCamera().getYaw();
         float var9 = mc.gameRenderer.getCamera().getPitch();
