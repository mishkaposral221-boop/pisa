...
public class ChinaHat extends ModuleStructure {
   ...
   public final ColorSetting color1 = new ColorSetting("Color 1", "First gradient color").value(ColorUtil.d(255, 50, 100, 255));
   public final ColorSetting color2 = new ColorSetting("Color 2", "Second gradient color").value(ColorUtil.d(100, 50, 255, 255));
   public final ColorSetting color3 = new ColorSetting("Color 3", "Third gradient color").value(ColorUtil.d(50, 255, 100, 255));
   public final ColorSetting color4 = new ColorSetting("Color 4", "Fourth gradient color").value(ColorUtil.d(255, 200, 50, 255));
