...
public class GpsArrow extends ModuleStructure {
   ...
   public void onDraw(DrawEvent var1) {
      if (active) {
         ...
         if (var2.player != null && var2.world != null) {
            DrawContext var3 = var1.getDrawContext();
            float var4 = var1.getPartialTicks();
            Vec3d var5 = var2.gameRenderer.getCamera().getCameraPos();
            double var6 = targetX - var5.x;
            double var8 = targetZ - var5.z;
            double var10 = targetY - var5.y;
            double var12 = Math.sqrt(var6 * var6 + var10 * var10 + var8 * var8);
            float var14 = var2.player.getYaw(var4);
            ...
            int var29 = var2.getWindow().getScaledWidth();
            int var18 = var2.getWindow().getScaledHeight();
   ...
   private void drawArrow(DrawContext var1, float var2, float var3, float var4) {
      float var5 = 20.0F;
