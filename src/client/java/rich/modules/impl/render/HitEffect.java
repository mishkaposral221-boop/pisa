...
public class HitEffect extends ModuleStructure {
   ...
   public void onAttack(AttackEvent var1) {
      if (this.isState() && var1.getTarget() != null) {
         if (var1.getTarget() instanceof LivingEntity var2) {
            this.hitTintEntities.put(var2.getId(), System.currentTimeMillis() + 350L);
         }
      }
   }
   ...
   public int getEntityTintColor() {
      return ColorUtil.h(this.colorSetting.getColor(), (int)this.alphaSetting.getValue());
   }
}
