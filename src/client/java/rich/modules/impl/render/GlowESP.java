        ...
        try {
            ...
            for (Entity entity : mc.world.getEntities()) {
                ...
                if (living.hurtTime > 0) {
                    outlineTop = RenderColor.of(255, 130, 130, (int)(200.0f * alphaM));
                    outlineBot = RenderColor.of(255, 50, 50, (int)(180.0f * alphaM));
                    ...
                    fillTop = RenderColor.of(40, 200, 150, (int)(14.0f * alphaM));
                    fillBot = RenderColor.of(20, 120, 80, (int)(10.0f * alphaM));
                }
