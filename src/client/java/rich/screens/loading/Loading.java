...
public class Loading {
   ...
   private void updateAnimations(float var1, long var2) {
      this.pulseTime += var1;
      this.animatedProgress = MathHelper.lerp(var1 * 5.0F, this.animatedProgress, this.targetProgress);
      this.progressGlow += var1 * 3.0F;
      this.backgroundAlpha = MathHelper.lerp(var1 * 4.0F, this.backgroundAlpha, 1.0F);
      if (this.backgroundAlpha > 0.99F) {
         this.backgroundAlpha = 1.0F;
      }

      if (!this.isFadingOut) {
         this.contentAlpha = MathHelper.lerp(var1 * 2.5F, this.contentAlpha, 1.0F);
   ...
   private void updateTextAnimation(long var1, float var3) {
      if (!this.allTextsShown) {
         ...
         if (this.isTransitioning) {
            ...
            float var6 = MathHelper.clamp((float)var8 / 400.0F, 0.0F, 1.0F);
            float var7 = this.easeOutCubic(var6);
            this.currentTextOffsetY = 14.0F * var7;
            this.currentTextAlpha = MathHelper.clamp(1.0F - var7 * 1.5F, 0.0F, 1.0F);
            this.newTextOffsetY = -12.0F * (1.0F - var7);
            this.newTextAlpha = MathHelper.clamp(var7 * 1.3F, 0.0F, 1.0F);
            if (var6 >= 1.0F) {
   ...
   private void renderProgressBar(int var1, int var2, float var3) {
      ...
      if (this.animatedProgress > 0.0F) {
         float var10 = var6 * MathHelper.clamp(this.animatedProgress, 0.0F, 1.0F);
   ...
   public void setProgress(float var1) {
      this.targetProgress = MathHelper.clamp(var1, 0.0F, 1.0F);
   }
