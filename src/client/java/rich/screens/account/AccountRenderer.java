...
public class AccountRenderer {
   ...
   public void renderLeftPanelBottom(float var1, float var2, float var3, float var4, float var5, String var6, String var7, Identifier var8) {
      ...
      if (!var6.isEmpty()) {
         ...
         float var29 = 24.0F;
         Identifier var30 = SkinManager.getSkin(var6);
   ...
   public void renderRightPanel(
      ...
      Render2D.blur(var1, var2, var3, var4, 0.0F, 0.0F, ColorUtil.b(0, 0, 0, 1));
      float var30 = var1 + 5.0F;
   ...
   private void renderAccountCard(
      ...
      Render2D.blur(var1, var2, 1.0F, 1.0F, 0.0F, 0.0F, ColorUtil.b(0, 0, 0, 0));
      ...
      float var22 = 25.0F;
      Identifier var23 = SkinManager.getSkin(var5.getName());
   ...
   public void drawPlayerFace(Identifier var1, float var2, float var3, float var4, int var5) {
      float var6 = 0.125F;
      float var7 = 0.125F;
      float var8 = 0.25F;
      float var9 = 0.25F;
