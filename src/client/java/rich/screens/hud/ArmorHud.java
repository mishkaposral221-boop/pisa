...
public class ArmorHud extends AbstractHudElement {
   ...
   private static final EquipmentSlot[] SLOTS_ORDER = new EquipmentSlot[]{EquipmentSlot.HEAD, EquipmentSlot.CHEST, EquipmentSlot.LEGS, EquipmentSlot.FEET};
   ...
   private void drawSlot(DrawContext var1, float var2, float var3, EquipmentSlot var4, int var5) {
      ItemStack var6 = this.mc.player.getEquippedStack(var4);
      int var7 = var6.isEmpty() ? new Color(30, 30, 35, (int)(140 * var5 / 255.0F)).getRGB() : new Color(45, 45, 55, (int)(160 * var5 / 255.0F)).getRGB();
      Render2D.rect(var2 + 1.0F, var3 + 1.0F, 22.0F, 27.0F, var7, 5.0F);
      if (!var6.isEmpty()) {
         var1.drawItem(var6, (int)(var2 + 4.0F), (int)(var3 + 4.0F));
         if (var6.isDamageable() && var6.getMaxDamage() > 0) {
            float var8 = 1.0F - (float)var6.getDamage() / var6.getMaxDamage();
