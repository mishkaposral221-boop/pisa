   ...
   public void drawDraggable(DrawContext var1, int var2) {
      if (var2 > 0 && this.mc.player != null) {
         ...
         if (this.lastUpdateTime > 0L && var6 > 0.0) {
            double var8 = this.mc.player.getX() - this.lastX;
            double var10 = this.mc.player.getZ() - this.lastZ;
         ...
         int var33 = (int)this.mc.player.getX();
         int var11 = (int)this.mc.player.getY();
         int var34 = (int)this.mc.player.getZ();
