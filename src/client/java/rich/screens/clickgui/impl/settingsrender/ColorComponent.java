...
public class ColorComponent extends AbstractSettingComponent {
   ...
   private void copyHexToClipboard() {
      if (this.hasHexSelection()) {
         GLFW.glfwSetClipboardString(mc.getWindow().getHandle(), "#" + this.getHexSelectedText());
   ...
   private void renderColorPicker(DrawContext var1, int var2, int var3, float var4) {
      float var5 = this.x;
