...
public class AutoBuyGuiComponent implements IMinecraft {
   ...
   private int getCurrentGuiScale() {
      int var1 = (Integer)mc.options.getGuiScale().getValue();
      if (var1 == 0) {
         var1 = mc.getWindow().calculateScaleFactor(0, mc.forcesUnicodeFont());
      }
   ...
   public void render(DrawContext var1, float var2, float var3, float var4, int var5, float var6) {
      ...
      var1.enableScissor(var36, var37, var38, var27);
   ...
   private void drawItemWithScaleCompensation(DrawContext var1, ItemStack var2, float var3, float var4, float var5, float var6, float var7) {
      if (!var2.isEmpty() && !(var6 <= 0.01F)) {
         float var8 = 16.0F * var5;
         float var9 = var3 + var8 / 2.0F;
         float var10 = var4 + var8 / 2.0F;
         Matrix3x2fStack var11 = var1.getMatrices();
         var11.pushMatrix();
   ...
   private void renderItem(DrawContext var1, AutoBuyableItem var2, float var3, float var4, float var5, float var6, float var7, float var8, float var9) {
      if (!(var8 <= 0.01F)) {
   ...
   private void queueItemIcon(AutoBuyableItem var1, float var2, float var3, float var4) {
      ItemStack var5 = var1.createItemStack();
   ...
   private static class PendingContextIcon {
      ...
      PendingContextIcon(ItemStack var1, float var2, float var3, float var4) {
         this.stack = var1;
         this.x = var2;
         this.y = var3;
         this.scale = var4;
   ...
   private static class PendingIcon {
      ...
      PendingIcon(ItemStack var1, float var2, float var3) {
         this.stack = var1;
         this.x = var2;
         this.y = var3;
      }
