...
public class AutoBuyItemSettings {
   ...
   public AutoBuyItemSettings(int var1, Item var2, String var3) {
      this.buyBelow = var1;
      this.material = var2;
   ...
   public AutoBuyItemSettings(int var1, Item var2, String var3, boolean var4) {
      this.buyBelow = var1;
      this.material = var2;
      this.displayName = var3;
   ...
   public void setMaterial(Item var1) {
      this.material = var1;
   }
