...
public class ThemeRenderer {
   ...
   public void render(DrawContext var1, float var2, float var3, float var4, float var5, float var6, float var7, float var8) {
      float var9 = 0.016F;
      ...
      Fonts.BOLD.draw("Select keyCodec colour theme for the client", var2 + 8.0F, var3 + 18.0F, 5.0F, new Color(120, 120, 120, var16).getRGB());
