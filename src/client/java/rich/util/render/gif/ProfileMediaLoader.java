...
public class ProfileMediaLoader {
   private static final List<Identifier> customAvatarFrames = new ArrayList<>();
   private static final List<Identifier> customBannerFrames = new ArrayList<>();
   ...
   private static void loadGif(File var0, List<Identifier> var1, boolean var2) {
      try {
         ...
         for (int var7 = 0; var7 < var6; var7++) {
            ...
            Identifier var9 = registerBufferedImage(var8, var2 ? "avatar" : "banner");
            if (var9 != null) {
               var1.add(var9);
            }
         }
   ...
   private static void loadImage(File var0, List<Identifier> var1, boolean var2) {
      try {
         ...
         Identifier var4 = registerBufferedImage(var3, var2 ? "avatar" : "banner");
         if (var4 != null) {
            var1.add(var4);
         }
      } catch (Exception var5) {
   ...
   private static Identifier registerBufferedImage(BufferedImage var0, String var1) {
      try {
         ...
         NativeImageBackedTexture var13 = new NativeImageBackedTexture(() -> "rich_profile_" + var1, var4);
         Identifier var14 = Identifier.of("rich", "profile/" + var1 + "_" + textureCounter++);
   ...
   private static void unregisterFrames(List<Identifier> var0) {
      for (Identifier var2 : var0) {
         try {
