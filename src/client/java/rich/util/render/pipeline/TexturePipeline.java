...
public class TexturePipeline {
   ...
   public void drawTexture(
      Identifier var1, float var2, float var3, float var4, float var5, float var6, float var7, float var8, float var9, int[] var10, float[] var11, float var12
   ) {
   ...
   public void drawTexture(
      ...
      if (var14.getFramebuffer() != null) {
         AbstractTexture var15 = var14.getTextureManager().getTexture(var1);
         if (var15 != null) {
            int var16;
            try {
               GpuTexture var17 = var15.getGlTexture();
               if (var17 == null) {
                  return;
               }
            ...
            int var22 = var14.getWindow().getFramebufferWidth();
            int var18 = var14.getWindow().getFramebufferHeight();
   ...
   private void uploadAndDraw(MinecraftClient var1, int var2) {
      ...
      GpuBufferSlice var5 = RenderSystem.getDynamicUniforms().write(RenderSystem.getModelViewMatrix(), COLOR_MODULATOR, MODEL_OFFSET, TEXTURE_MATRIX);
      GL13.glActiveTexture(33984);
      GL11.glBindTexture(3553, var2);
      RenderPass var6 = var4.createRenderPass(
         () -> "minecraft:texture_pass", var1.getFramebuffer().getColorAttachmentView(), OptionalInt.empty(), var1.getFramebuffer().getDepthAttachmentView(), OptionalDouble.empty()
      );
