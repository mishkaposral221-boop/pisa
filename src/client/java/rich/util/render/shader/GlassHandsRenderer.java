...
public class GlassHandsRenderer {
   ...
   public void captureSceneBeforeHands() {
      if (this.enabled) {
         this.ensureInitialized();
         Framebuffer var1 = this.client.getFramebuffer();
         if (var1 != null && var1.getColorAttachment() != null) {
            ...
            var4.copyTextureToTexture(var1.getColorAttachment(), this.sceneBeforeTexture, 0, 0, 0, 0, 0, var2, var3);
            if (var1.getDepthAttachment() != null) {
               var4.copyTextureToTexture(var1.getDepthAttachment(), this.depthBeforeTexture, 0, 0, 0, 0, 0, var2, var3);
            }
   ...
   public void captureSceneAfterHands() {
      if (this.enabled && this.capturing) {
         ...
         if (var1 != null && var1.getColorAttachment() != null) {
            ...
            var2.copyTextureToTexture(var1.getColorAttachment(), this.sceneAfterTexture, 0, 0, 0, 0, 0, this.lastWidth, this.lastHeight);
            if (var1.getDepthAttachment() != null) {
               var2.copyTextureToTexture(var1.getDepthAttachment(), this.depthAfterTexture, 0, 0, 0, 0, 0, this.lastWidth, this.lastHeight);
            }
         }
      }
   }
