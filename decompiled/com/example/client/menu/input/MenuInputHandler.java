...
public class MenuInputHandler {
    ...
    public void updateHover(class_310 client, int baseX, int baseY) {
        double mx = client.field_1729.method_1603() * (double)client.method_22683().method_4486() / (double)client.method_22683().method_4480();
        double my = client.field_1729.method_1604() * (double)client.method_22683().method_4502() / (double)client.method_22683().method_4507();
        int cw = this.layout.CW();
        int p = this.layout.P();
        int hh = this.layout.HH();
        int ih = this.layout.IH();
