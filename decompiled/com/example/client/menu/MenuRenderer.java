...
public class MenuRenderer {
    ...
    public int getMenuX() {
        return (class_310.method_1551().method_22683().method_4486() - this.layout.TOTAL_W()) / 2;
    }

    public int getMenuY() {
        return (class_310.method_1551().method_22683().method_4502() - this.layout.CH()) / 2;
    }
    ...
    private void renderShapesInternal() {
        ...
        for (int col = 0; col < MenuData.CATEGORIES.length; ++col) {
            ...
            int guiScale = class_310.method_1551().method_22683().method_4495();
