...
public class ClickGui extends class_437 implements IMinecraft {
   ...
   protected void method_25426() {
      ...
      double var3 = mc.method_22683().method_4480() / 2.0;
      double var5 = mc.method_22683().method_4507() / 2.0;
   ...
   private float[] calculateBackground(float var1) {
      int var2 = mc.method_22683().method_4480() / 2;
      int var3 = mc.method_22683().method_4507() / 2;
   ...
   public void renderOverlay(class_332 var1, class_9779 var2) {
      if (mc.method_22683() != null) {
         ...
         int var8 = mc.method_22683().method_4486();
         int var9 = mc.method_22683().method_4502();
         var1.method_71048();
         ...
         int var11 = mc.method_22683().method_4476((Integer)mc.field_1690.method_42474().method_41753(), mc.method_1573());
         ...
         var1.method_51448().scale(var12, var12);
   ...
   public boolean method_25402(class_11909 var1, boolean var2) {
      ...
      int var3 = mc.method_22683().method_4476((Integer)mc.field_1690.method_42474().method_41753(), mc.method_1573());
      float var4 = 2.0F / var3;
      double var5 = var1.comp_4798() / var4;
      double var7 = var1.comp_4799() / var4;
      ...
      if (this.background.isSearchActive()) {
         ...
         if (var1.method_74245() == 0 && this.isSearchBarClick(var5, var7, var10, var13)) {
         ...
         if (this.isModuleCategory(this.selectedCategory)) {
            if (this.selectedCategory == ModuleCategory.THEMES) {
               ...
               if (this.themeRenderer.mouseClicked((float)var5, (float)var7, var29, var31, var1.method_74245())) {
                  return true;
               }
            } else if (this.selectedCategory == ModuleCategory.CONFIGS) {
               if (this.configsRenderer.mouseClicked((float)var5, (float)var7, var1.method_74245(), var10, var13)) {
                  return true;
               }
            } else {
               ModuleStructure var30 = this.moduleComponent.getModuleForStarClick(var5, var7, var14, var15, var16, var17);
               if (var30 != null && var1.method_74245() == 0) {
         ...
         if (var1.method_74245() == 0 && this.tryStartSettingsPanelDrag(var5, var7, var10, var13)) {
            return true;
         } else {
            return this.tryClickSettingsPanel(var5, var7, var10, var13, var1.method_74245()) ? true : super.method_25402(var1, var2);
         }
      }
   }
   ...
   public boolean method_25406(class_11909 var1) {
      ...
      if (this.catBarDragging) {
         int var2 = mc.method_22683().method_4476((Integer)mc.field_1690.method_42474().method_41753(), mc.method_1573());
      ...
      for (AbstractSettingComponent var8 : this.moduleComponent.getSettingComponents()) {
         if (var8.getSetting().isVisible() && var8.mouseReleased(var1.comp_4798(), var1.comp_4799(), var1.method_74245())) {
            return true;
         }
      }
   ...
   public boolean method_25401(double var1, double var3, double var5, double var7) {
      ...
      if (this.moduleComponent.getBindingModule() != null) {
         ...
         int var22 = mc.method_22683().method_4476((Integer)mc.field_1690.method_42474().method_41753(), mc.method_1573());
         ...
         if (this.background.isSearchActive() && var24 >= var18 && var24 <= var18 + var20 && var13 >= var19 && var13 <= var19 + var21) {
            ...
            return this.tryScrollSettingsPanel(var24, var13, var16, var17, var7) ? true : super.method_25401(var1, var3, var5, var7);
         }
      }
   }
   ...
   public boolean method_25404(class_11908 var1) {
      if (var1.comp_4795() == 256) {
         ...
         if (var1.comp_4795() == 70 && (var1.comp_4797() & 2) != 0) {
            this.background.setSearchActive(!this.background.isSearchActive());
            return true;
         }

         if (this.background.isSearchActive() && this.background.handleSearchKey(var1.comp_4795())) {
            return true;
         }

         if (this.dragHandler.isResetNeeded(var1.comp_4795(), var1.comp_4797())) {
         ...
         if (var2 != null) {
            var2.setKey(var1.comp_4795() == 261 ? -1 : var1.comp_4795());
            this.moduleComponent.setBindingModule(null);
            return true;
         }

         for (AbstractSettingComponent var4 : this.moduleComponent.getSettingComponents()) {
            if (var4.getSetting().isVisible() && var4.keyPressed(var1.comp_4795(), var1.comp_4796(), var1.comp_4797())) {
               return true;
            }
         }

         return this.selectedCategory == ModuleCategory.CONFIGS && this.configsRenderer.keyPressed(var1.comp_4795()) ? true : super.method_25404(var1);
      }
   }
   ...
   public boolean method_25400(class_11905 var1) {
      ...
      if (this.background.isSearchActive() && this.background.handleSearchChar((char)var1.comp_4793())) {
         return true;
      }

      for (AbstractSettingComponent var3 : this.moduleComponent.getSettingComponents()) {
         if (var3.getSetting().isVisible() && var3.charTyped((char)var1.comp_4793(), var1.comp_4794())) {
            return true;
         }
      }

      return this.selectedCategory == ModuleCategory.CONFIGS && this.configsRenderer.charTyped((char)var1.comp_4793()) ? true : super.method_25400(var1);
   }
   ...
   private void renderSettingsPanelExternal(class_332 var1, float var2, float var3, float var4, float var5, float var6, float var7) {
