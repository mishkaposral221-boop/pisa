...
public class MainMenuScreen extends class_437 {
   private static final class_2960 BACKGROUND_TEXTURE = class_2960.method_60655("rich", "textures/menu/backmenu.png");
   ...
   public MainMenuScreen() {
      super(class_2561.method_43470("Main Menu"));
   ...
   private int getFixedScaledWidth() {
      return (int)Math.ceil(this.field_22787.method_22683().method_4489() / 2.0);
   }

   private int getFixedScaledHeight() {
      return (int)Math.ceil(this.field_22787.method_22683().method_4506() / 2.0);
   }

   private float getScaleMultiplier() {
      float var1 = this.field_22787.method_22683().method_4495();
      return var1 / 2.0F;
   }

   private float toFixedCoord(double var1) {
      float var3 = this.field_22787.method_22683().method_4495();
   ...
   private void unlock() {
      if (!this.isUnlocked) {
         ...
         this.unlockTime = class_156.method_658();
   ...
   private float getUnlockTextAlpha(long var1) {
      ...
      return 1.0F - class_3532.method_15363((float)var3 / 300.0F, 0.0F, 1.0F);
   }
   ...
   private float getMenuProgress(long var1) {
      ...
      return var3 < 0L ? 0.0F : class_3532.method_15363((float)var3 / 800.0F, 0.0F, 1.0F);
   }
   ...
   private void switchToView(MainMenuScreen.View var1) {
      if (this.currentView != var1 && this.transitionPhase == MainMenuScreen.TransitionPhase.NONE) {
         ...
         this.transitionStart = class_156.method_658();
      }
   }
      ...
      if (this.currentView == MainMenuScreen.View.ALT_SCREEN && this.transitionPhase == MainMenuScreen.TransitionPhase.NONE) {
         ...
         if (this.transitionPhase == MainMenuScreen.TransitionPhase.FADE_OUT) {
            return this.currentView == MainMenuScreen.View.MAIN_MENU
               ? 1.0F - this.easeInCubic(class_3532.method_15363((float)var3 / 200.0F, 0.0F, 1.0F))
               : 0.0F;
         } else if (this.transitionPhase == MainMenuScreen.TransitionPhase.FADE_IN) {
            return this.currentView == MainMenuScreen.View.MAIN_MENU ? this.easeOutCubic(class_3532.method_15363((float)var3 / 250.0F, 0.0F, 1.0F)) : 0.0F;
         } else {
   ...
   private float getAltScreenAlpha(long var1) {
      if (this.currentView == MainMenuScreen.View.MAIN_MENU && this.transitionPhase == MainMenuScreen.TransitionPhase.NONE) {
         ...
         if (this.transitionPhase == MainMenuScreen.TransitionPhase.FADE_OUT) {
            ...
            return this.currentView == MainMenuScreen.View.ALT_SCREEN ? this.easeOutCubic(class_3532.method_15363((float)var3 / 250.0F, 0.0F, 1.0F)) : 0.0F;
         } else {
   ...
   public void method_25394(class_332 var1, int var2, int var3, float var4) {
      long var5 = class_156.method_658();
      if (!this.initialized) {
      ...
      this.lastRenderTime = var5;
      var7 = class_3532.method_15363(var7, 0.0F, 0.1F);
      this.updateTransition(var5);
      this.unlockTextPulse += var7 * 3.0F;
      this.currentZoom = class_3532.method_16439(var7 * 3.0F, this.currentZoom, this.targetZoom);
      float var8 = 12.0F;
      ...
      if (this.currentView == MainMenuScreen.View.MAIN_MENU && var11 > 0.3F) {
         ...
         String var28 = class_156.method_658() - this.hwidCopiedTime < 1500L ? "✓ Скопировано" : "[копировать]";
   ...
   private void updateButtonAnimations(float var1) {
      for (int var2 = 0; var2 < 5; var2++) {
         ...
         this.buttonHoverProgress[var2] = class_3532.method_16439(var1 * 10.0F, this.buttonHoverProgress[var2], var3);
         float var4 = this.hoveredButton == var2 ? 1.08F : 1.0F;
         this.buttonScales[var2] = class_3532.method_16439(var1 * 12.0F, this.buttonScales[var2], var4);
      }

      float var5 = this.hoveredButton == 4 ? 1.0F : 0.0F;
      this.exitButtonRedProgress = class_3532.method_16439(var1 * 8.0F, this.exitButtonRedProgress, var5);
   }
   ...
   private void renderButtons(float var1, float var2, float var3, int var4, int var5, float var6, float var7) {
      ...
      for (int var12 = 0; var12 < 5; var12++) {
         ...
         float var14 = class_3532.method_15363((var6 - var13) / (1.0F - var13 * 0.5F), 0.0F, 1.0F);
   ...
   private void renderCircleButton(int var1, float var2, float var3, float var4) {
      if (!(var4 < 0.01F)) {
         ...
         if (var1 == 4) {
            ...
            int var25 = class_3532.method_48781(var24, 20, 42);
            int var26 = class_3532.method_48781(var24, 23, 20);
            int var27 = class_3532.method_48781(var24, 31, 20);
            ...
            int var28 = class_3532.method_48781(var24, 37, 90);
            int var29 = class_3532.method_48781(var24, 42, 58);
            int var30 = class_3532.method_48781(var24, 54, 58);
            var22 = this.withAlpha(var28 << 16 | var29 << 8 | var30, var16);
            short var31 = 255;
            int var32 = class_3532.method_48781(var24, 255, 140);
            int var33 = class_3532.method_48781(var24, 255, 140);
   ...
   public boolean method_25402(class_11909 var1, boolean var2) {
      ...
      float var3 = this.toFixedCoord(var1.comp_4798());
      float var4 = this.toFixedCoord(var1.comp_4799());
      ...
      if (this.currentView == MainMenuScreen.View.MAIN_MENU) {
         ...
         if (var1.method_74245() == 0 && this.hoveredButton >= 0) {
   ...
   private boolean handleAltScreenClick(float var1, float var2, class_11909 var3) {
   ...
   public boolean method_25401(double var1, double var3, double var5, double var7) {
      if (this.currentView == MainMenuScreen.View.ALT_SCREEN && this.transitionPhase == MainMenuScreen.TransitionPhase.NONE) {
         ...
         if (this.accountRenderer.isMouseOver(var9, var10, var19, var20, 300.0F, 165.0F)) {
            ...
            this.targetScrollOffset = class_3532.method_15363(this.targetScrollOffset, 0.0F, var25);
            return true;
         } else {
   ...
   public boolean method_25404(class_11908 var1) {
      ...
      if (var1.comp_4795() == 256 && this.updateNotification.isVisible()) {
         return this.updateNotification.keyPressed(var1.comp_4795());
      }
   ...
   private class_2960 getSkinTexturePath(class_8685 var1) {
      if (var1 != null && var1.comp_1626() != null) {
         try {
            return var1.comp_1626().comp_3627();
   ...
   private class_2960 getSkinForPlayer(String var1) {
      if (this.field_22787 != null && this.field_22787.field_1724 != null && this.field_22787.field_1724.field_3944 != null) {
         for (class_640 var3 : this.field_22787.field_1724.field_3944.method_2880()) {
            if (var3.method_2966() != null && var3.method_2966().name().equalsIgnoreCase(var1)) {
               try {
                  class_8685 var4 = var3.method_52810();
                  class_2960 var5 = this.getSkinTexturePath(var4);
   ...
   private class_2960 getLocalPlayerSkin() {
      if (this.field_22787 != null && this.field_22787.field_1724 != null && this.field_22787.field_1724.field_3944 != null) {
         try {
            class_640 var1 = this.field_22787.field_1724.field_3944.method_2871(this.field_22787.field_1724.method_5667());
            if (var1 != null) {
               class_8685 var2 = var1.method_52810();
   ...
   private void renderHwidWidget(int var1, int var2, float var3) {
      if (!(var3 < 0.01F)) {
         ...
         if (var4 != null && !var4.isEmpty()) {
            ...
            long var19 = class_156.method_658();
