...
public class Notifications extends AbstractHudElement {
   ...
   private int getCurrentGuiScale() {
      int var1 = (Integer)this.mc.field_1690.method_42474().method_41753();
      if (var1 == 0) {
         var1 = this.mc.method_22683().method_4476(0, this.mc.method_1573());
      }
   ...
   private float getVirtualWidth() {
      return this.mc.method_22683().method_4489() / 2.0F;
   }

   private float getVirtualHeight() {
      return this.mc.method_22683().method_4506() / 2.0F;
   }
