...
public class Watermark extends AbstractHudElement {
   ...
   public void drawDraggable(class_332 var1, int var2) {
      if (var2 > 0) {
         ...
         String var6 = var5 != null && var5.isState() ? "Protected" : this.mc.method_1548().method_1676();
         String var7 = String.valueOf(this.mc.method_47599());
         String var8 = "fps";
         ...
         float var30 = 16.0F;
         Render2D.texture(class_2960.method_60655("rich", "icon.png"), var3 + 2.0F, var4 + 5.0F, var30, var30, -1);
