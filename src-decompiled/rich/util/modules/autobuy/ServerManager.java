...
public class ServerManager {
   ...
   public void updateHubStatus(class_638 var1) {
      this.inHub = this.isInHubInternal(var1);
   }

   private boolean isInHubInternal(class_638 var1) {
      if (var1 == null) {
         return true;
      }

      class_269 var2 = var1.method_8428();
   ...
   private int getCurrentAnarchyNumber(class_638 var1) {
      if (var1 == null) {
         return -1;
      }
   ...
   private String getNextServer(List<String> var1, class_638 var2) {
      if (var1.isEmpty()) {
         return null;
      }
   ...
   public void switchToNextServer(class_746 var1, NetworkManager var2, String var3) {
      if (this.serverSwitchCooldown.hasTimeElapsed(3000L)) {
         List var4 = this.getAvailableServers(var3);
         if (var4 != null && !var4.isEmpty()) {
            class_638 var5 = (class_638)var1.method_73183();
            String var6 = this.getNextServer(var4, var5);
            if (var6 != null) {
               this.currentServer = var6;
               var1.field_3944.method_45730(var6.substring(1));
   ...
   public void joinAnarchyFromHub(class_746 var1, String var2) {
      List var3 = this.getAvailableServers(var2);
      if (var3 != null && !var3.isEmpty()) {
         String var4 = (String)var3.get(0);
         var1.field_3944.method_45730(var4.substring(1));
         this.waitingForServerLoad = true;
         this.hubCheckTimer.resetCounter();
      }
   }
