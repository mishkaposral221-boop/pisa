...
public class GlassCompositePipeline {
   private static final class_2960 PIPELINE_ID = class_2960.method_60655("rich", "pipeline/glass_composite");
   private static final class_2960 VERTEX_SHADER = class_2960.method_60655("rich", "core/glass_composite");
   private static final class_2960 FRAGMENT_SHADER = class_2960.method_60655("rich", "core/glass_composite");
   ...
   private static final RenderPipeline PIPELINE = class_10799.method_67887(
      RenderPipeline.builder(new Snippet[]{class_10799.field_60125})
         ...
         .withUniform("GlassData", class_10789.field_60031)
   ...
   public void composite(
      ...
      GpuBufferSlice var14 = RenderSystem.getDynamicUniforms().method_71106(RenderSystem.getModelViewMatrix(), COLOR_MODULATOR, MODEL_OFFSET, TEXTURE_MATRIX);
