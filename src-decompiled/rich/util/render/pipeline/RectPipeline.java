...
public class RectPipeline {
   private static final class_2960 PIPELINE_ID = class_2960.method_60655("rich", "pipeline/rect");
   private static final class_2960 VERTEX_SHADER = class_2960.method_60655("rich", "core/rect");
   private static final class_2960 FRAGMENT_SHADER = class_2960.method_60655("rich", "core/rect");
   ...
   private static final RenderPipeline PIPELINE = class_10799.method_67887(
      RenderPipeline.builder(new Snippet[]{class_10799.field_60125})
         ...
         .withUniform("RectData", class_10789.field_60031)
   ...
   private void uploadAndDraw(class_310 var1) {
      ...
      RenderPass var5 = var3.createRenderPass(
         () -> "minecraft:rect_pass", var1.method_1522().method_71639(), OptionalInt.empty(), var1.method_1522().method_71640(), OptionalDouble.empty()
      );
