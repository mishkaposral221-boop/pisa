...
public class WheelPipeline {
   ...
   private static final RenderPipeline PIPELINE = class_10799.method_67887(
      RenderPipeline.builder(new Snippet[]{class_10799.field_60125})
         .withLocation(class_2960.method_60655("rich", "pipeline/wheel_segment"))
         .withVertexShader(class_2960.method_60655("rich", "core/wheel_segment"))
         .withFragmentShader(class_2960.method_60655("rich", "core/wheel_segment"))
         .withVertexFormat(class_290.field_60033, class_5596.field_27379)
         .withUniform("WheelSegData", class_10789.field_60031)
   ...
   public void drawSegment(float var1, float var2, float var3, float var4, float var5, float var6, int var7) {
      ...
      if (var8.method_1522() != null) {
         ...
         float var11 = (float)var9 / var8.method_22683().method_4486();
         float var12 = (float)var10 / var8.method_22683().method_4502();
         ...
         RenderPass var23 = var21.createRenderPass(
            () -> "rich:wheel_segment", var8.method_1522().method_71639(), OptionalInt.empty(), var8.method_1522().method_71640(), OptionalDouble.empty()
         );
