...
public class GlowOutlinePipeline {
   private static final class_2960 PIPELINE_ID = class_2960.method_60655("rich", "pipeline/glow_outline");
   private static final class_2960 VERTEX_SHADER = class_2960.method_60655("rich", "core/glow_outline");
   private static final class_2960 FRAGMENT_SHADER = class_2960.method_60655("rich", "core/glow_outline");
   ...
   private static final RenderPipeline PIPELINE = class_10799.method_67887(
      RenderPipeline.builder(new Snippet[]{class_10799.field_60125})
         ...
         .withUniform("GlowOutlineData", class_10789.field_60031)
   ...
   public void drawGlowOutline(float var1, float var2, float var3, float var4, int var5, float var6, float[] var7, float var8, float var9) {
      ...
      if (var10.method_1522() != null) {
         ...
         int var11 = var10.method_22683().method_4489();
         int var12 = var10.method_22683().method_4506();
   ...
   private void uploadAndDraw(class_310 var1) {
      ...
      RenderPass var5 = var3.createRenderPass(
         () -> "minecraft:glow_outline_pass", var1.method_1522().method_71639(), OptionalInt.empty(), var1.method_1522().method_71640(), OptionalDouble.empty()
      );
