...
public class BlurPipeline {
   private static final class_2960 PIPELINE_ID = class_2960.method_60655("rich", "pipeline/blur");
   private static final class_2960 VERTEX_SHADER = class_2960.method_60655("rich", "core/blur");
   private static final class_2960 FRAGMENT_SHADER = class_2960.method_60655("rich", "core/blur");
   ...
   public void drawBlur(float var1, float var2, float var3, float var4, float var5, float[] var6, int var7) {
      ...
      if (var8.method_1522() != null) {
         if (var8.method_1522().method_30277() != null) {
            this.ensureInitialized();
            int var9 = var8.method_1522().field_1482;
            int var10 = var8.method_1522().field_1481;
            ...
            var13.copyTextureToTexture(var8.method_1522().method_30277(), this.copyTexture, 0, 0, 0, 0, 0, var9, var10);
            ...
            class_12137 var15 = RenderSystem.getSamplerCache().method_75294(FilterMode.LINEAR);
            RenderPass var16 = var13.createRenderPass(
               () -> "minecraft:blur_pass", var8.method_1522().method_71639(), OptionalInt.empty(), var8.method_1522().method_71640(), OptionalDouble.empty()
            );
