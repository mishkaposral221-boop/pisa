...
public class Render2D {
   ...
   public static int getFixedScaledWidth() {
      ...
      return (int)Math.ceil(var0.method_4489() / 2.0);
   }

   public static int getFixedScaledHeight() {
      class_1041 var0 = class_310.method_1551().method_22683();
      return (int)Math.ceil(var0.method_4506() / 2.0);
   }
   ...
   public static float getScaleMultiplier() {
      ...
      float var1 = var0.method_22683().method_4495();
      return 2.0F / var1;
   }
   ...
   public static void texture(class_2960 var0, float var1, float var2, float var3, float var4, int var5) {
      texture(var0, var1, var2, var3, var4, 0.0F, 0.0F, 1.0F, 1.0F, var5, 1.0F, 0.0F);
   }

   public static void texture(class_2960 var0, float var1, float var2, float var3, float var4, float var5, int var6) {
      texture(var0, var1, var2, var3, var4, 0.0F, 0.0F, 1.0F, 1.0F, var6, var5, 0.0F);
   }

   public static void texture(class_2960 var0, float var1, float var2, float var3, float var4, float var5, float var6, int var7) {
      texture(var0, var1, var2, var3, var4, 0.0F, 0.0F, 1.0F, 1.0F, var7, var5, var6);
   }

   public static void texture(class_2960 var0, float var1, float var2, float var3, float var4, float var5, float var6, float var7, float var8, int var9) {
      texture(var0, var1, var2, var3, var4, var5, var6, var7, var8, var9, 1.0F, 0.0F);
   }

   public static void texture(
      class_2960 var0, float var1, float var2, float var3, float var4, float var5, float var6, float var7, float var8, int var9, float var10
   ) {
      texture(var0, var1, var2, var3, var4, var5, var6, var7, var8, var9, 1.0F, var10);
   }

   public static void texture(
      class_2960 var0, float var1, float var2, float var3, float var4, float var5, float var6, float var7, float var8, int var9, float var10, float var11
   ) {
   ...
   public static void drawSprite(class_1058 var0, float var1, float var2, float var3, float var4, int var5) {
      drawSprite(var0, var1, var2, var3, var4, var5, true);
   }

   public static void drawSprite(class_1058 var0, float var1, float var2, float var3, float var4, int var5, boolean var6) {
      if (var0 != null && var3 != 0.0F && var4 != 0.0F) {
         float var7 = var6 ? 1.0F : 0.0F;
         texture(var0.method_45852(), var1, var2, var3, var4, var0.method_4594(), var0.method_4593(), var0.method_4577(), var0.method_4575(), var5, var7, 0.0F);
      }
   }

   public static void drawSpriteSmooth(class_1058 var0, float var1, float var2, float var3, float var4, int var5) {
   ...
   public static void arc(class_332 var0, float var1, float var2, float var3, float var4, float var5, float var6, int var7, boolean var8) {
      arc(createProjection(), var1, var2, var3, var4, var5, var6, var7, var8);
   }

   public static void arc(class_332 var0, float var1, float var2, float var3, float var4, float var5, float var6, boolean var7, int... var8) {
      arc(createProjection(), var1, var2, var3, var4, var5, var6, var7, var8);
   }
   ...
   public static void arcOutline(
      class_332 var0, float var1, float var2, float var3, float var4, float var5, float var6, float var7, int var8, int var9, boolean var10
   ) {
