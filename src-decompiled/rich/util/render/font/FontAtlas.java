...
public class FontAtlas {
   ...
   private final class_2960 jsonId;
   ...
   public FontAtlas(class_2960 var1, class_2960 var2) {
      this.jsonId = var1;
      this.textureId = var2;
   ...
   private void doLoad() {
      try {
         Optional var1 = class_310.method_1551().method_1478().method_14486(this.jsonId);
         if (var1.isEmpty()) {
         ...
         try (
            InputStream var2 = ((class_3298)var1.get()).method_14482();
