...
public class FontPipeline {
   private static final class_2960 PIPELINE_ID = class_2960.method_60655("rich", "pipeline/msdf");
   private static final class_2960 SHADER_ID = class_2960.method_60655("rich", "core/msdf");
   ...
   private static final RenderPipeline PIPELINE = class_10799.method_67887(
      RenderPipeline.builder(new Snippet[]{class_10799.field_60125})
         ...
         .withUniform("FontData", class_10789.field_60031)
   ...
   public void flush() {
      if (!this.charBatch.isEmpty() && this.currentAtlas != null) {
         class_310 var1 = class_310.method_1551();
         if (var1.method_1522() == null) {
            this.charBatch.clear();
            this.currentAtlas = null;
         } else {
            class_1044 var2 = var1.method_1531().method_4619(this.currentAtlas.getTextureId());
            if (var2 == null) {
               this.charBatch.clear();
               this.currentAtlas = null;
            } else {
               ...
               class_12137 var7 = RenderSystem.getSamplerCache().method_75294(FilterMode.LINEAR);
               RenderPass var8 = var5.createRenderPass(
                  () -> "rich:font_pass", var1.method_1522().method_71639(), OptionalInt.empty(), var1.method_1522().method_71640(), OptionalDouble.empty()
               );
   ...
   private void prepareUniformData(class_310 var1, FontAtlas var2, float var3, int var4) {
