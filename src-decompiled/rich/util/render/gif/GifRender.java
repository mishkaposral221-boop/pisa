...
public class GifRender {
   private static final List<class_2960> avatarFrames = new ArrayList<>();
   private static final List<class_2960> backgroundFrames = new ArrayList<>();
   ...
   public static void init() {
      if (!initialized) {
         ...
         for (int var0 = 1; var0 <= 100; var0++) {
            ...
            class_2960 var2 = class_2960.method_60655("rich", "images/gifs/avatar/" + var1 + ".png");
            avatarFrames.add(var2);
         }

         for (int var3 = 0; var3 <= 16; var3++) {
            String var4 = String.format("frame_%02d_delay-0.05s", var3);
            class_2960 var5 = class_2960.method_60655("rich", "images/gifs/back/" + var4 + ".png");
