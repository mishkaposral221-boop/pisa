...
public final class MathUtils implements IMinecraft {
   ...
   public static float textScrolling(float var0) {
      ...
      return (float)class_3532.method_15350(System.currentTimeMillis() % var1 * Math.PI / var1, 0.0, 1.0) * var0;
   }
   ...
   public static int applyOpacity(int var0, float var1) {
      return class_9848.method_61324((int)(getAlpha(var0) * var1 / 255.0F), getRed(var0), getGreen(var0), getBlue(var0));
   }

   public static int applyContextAlpha(int var0) {
      int var1 = (int)(getAlpha(var0) * contextAlpha);
      return class_9848.method_61324(var1, getRed(var0), getGreen(var0), getBlue(var0));
   }

   public static class_243 cosSin(int var0, int var1, double var2) {
   ...
   public static class_243 interpolate(class_243 var0, class_243 var1) {
      return new class_243(
         interpolate(var0.field_1352, var1.field_1352), interpolate(var0.field_1351, var1.field_1351), interpolate(var0.field_1350, var1.field_1350)
      );
   }
   ...
   public static class_243 interpolate(class_1297 var0) {
      return var0 == null
         ...
         : new class_243(
            interpolate(var0.field_6014, var0.method_23317()),
            interpolate(var0.field_6036, var0.method_23318()),
            interpolate(var0.field_5969, var0.method_23321())
         );
   }

   public static float interpolate(float var0, float var1) {
      return class_3532.method_16439(tickCounter.method_60637(false), var0, var1);
   }

   public static double interpolate(double var0, double var2) {
      return class_3532.method_16436(tickCounter.method_60637(false), var0, var2);
   }

   public static float interpolateSmooth(double var0, float var2, float var3) {
      return (float)class_3532.method_16436(tickCounter.method_60638() / var0, var2, var3);
   }
