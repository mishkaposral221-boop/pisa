...
public final class a {
   ...
   public static int a(float var0, int var1, int var2) {
      return class_9848.method_61319(var0, var1, var2);
   }
   ...
   public static int e(int var0, int var1) {
      ...
      return class_9848.method_61323(n(var2.get()), o(var2.get()), p(var2.get()));
   }
   ...
   public static int e(int var0, int var1, float var2) {
      ...
      return d(
         class_3532.method_48781(var3, a(var0), a(var1)),
         class_3532.method_48781(var3, b(var0), b(var1)),
         class_3532.method_48781(var3, c(var0), c(var1)),
         class_3532.method_48781(var3, d(var0), d(var1))
      );
   }
   ...
   public static int b(float var0, float var1, float var2, float var3) {
      return (int)(class_3532.method_15363(var3, 0.0F, 1.0F) * 255.0F) << 24
         | (int)(class_3532.method_15363(var0, 0.0F, 1.0F) * 255.0F) << 16
         | (int)(class_3532.method_15363(var1, 0.0F, 1.0F) * 255.0F) << 8
         | (int)(class_3532.method_15363(var2, 0.0F, 1.0F) * 255.0F);
   }
