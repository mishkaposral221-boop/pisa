...
public class ClientTheme {
   ...
   public static void applyToModules() {
      ...
      apply(HitEffect.class, var1x -> var1x.colorSetting.setColor(var0));
      apply(Arrows.class, var1x -> var1x.arrowColor.setColor(var0));
      apply(Particles.class, var1x -> var1x.color.setColor(var0));
      apply(WorldParticles.class, var1x -> var1x.cubeColor.setColor(var0));
      apply(Esp.class, var1x -> var1x.boxColor.setColor(var0));
      apply(JumpCircle.class, var2 -> var2.applyThemeColors(var0, var1));
      apply(TargetESP.class, var2 -> var2.applyThemeColors(var0, var1));
      apply(ChinaHat.class, var2 -> {
      ...
      apply(GroundPulse.class, var1x -> var1x.colorSetting.setColor(var0));
      apply(GhostTrail.class, var1x -> var1x.color.setColor(var0));
      apply(CustomSky.class, var1x -> var1x.color.setColor(var0));
      apply(CustomFog.class, var1x -> var1x.color.setColor(var0));
      apply(BlockOverlay.class, var1x -> var1x.applyThemeColor(var0));
   }

   private static <T extends ModuleStructure> void apply(Class<T> var0, Consumer<T> var1) {
      try {
