...
public class TargetESP extends ModuleStructure implements IMinecraft {
   ...
   public void onRender3D(WorldRenderEvent var1) {
      ...
      if (mc.field_1692 instanceof class_1309 var4 && var4.method_5805() && var4 != mc.field_1724 && !var4.method_5767()) {
         var3 = var4;
      }
      ...
      if (!var14) {
         ...
         class_1309 var15 = this.lastTarget;
         ...
         if (!(var6 <= 0.01F)) {
            ...
            this.hurtProgress = var15.field_6235 > 0 ? var15.field_6235 / 10.0F : Math.max(0.0F, this.hurtProgress - var7);
            Render3D.updateTargetEsp(var2);
            if (this.mode.isSelected("Circle")) {
               this.renderCircle(var1.getStack(), var15, var6);
            } else {
               class_4587 var8 = var1.getStack();
               class_4598 var9 = mc.method_22940().method_23000();
               class_243 var10 = mc.field_1773.method_19418().method_71156();
               float var11 = var1.getPartialTicks();
               class_243 var12 = var15.method_30950(var11);
               if (this.lastTarget == var15 && this.hasSmoothedPos) {
                  float var13 = Math.min(1.0F, var11 * 1.5F);
                  this.smoothedPosX = this.smoothedPosX + (var12.field_1352 - this.smoothedPosX) * var13;
                  this.smoothedPosY = this.smoothedPosY + (var12.field_1351 - this.smoothedPosY) * var13;
                  this.smoothedPosZ = this.smoothedPosZ + (var12.field_1350 - this.smoothedPosZ) * var13;
               } else {
                  this.smoothedPosX = var12.field_1352;
                  this.smoothedPosY = var12.field_1351;
                  this.smoothedPosZ = var12.field_1350;
                  this.lastTarget = var15;
                  this.hasSmoothedPos = true;
               }

               var8.method_22903();
               var8.method_22904(this.smoothedPosX - var10.field_1352, this.smoothedPosY - var10.field_1351, this.smoothedPosZ - var10.field_1350);
   ...
   private void renderCircle(class_4587 var1, class_1309 var2, float var3) {
   ...
   private void renderChain(class_4587 var1, class_4597 var2, class_1309 var3, float var4, float var5) {
      class_4588 var6 = var2.method_73477(ClientPipelines.CHAIN_ESP.apply(class_2960.method_60655("rich", "images/world/chain.png")));
      ...
      float var11 = var3.method_17681() * 3.0F;
      byte var12 = 18;
      short var13 = 720;
      float var14 = 8.0F;
      float var15 = 1.5F;
      float var16 = 0.5F;
      int var17 = class_3532.method_15340((int)(var4 * 128.0F), 0, 128);
      ...
      for (int var23 = 0; var23 < 2; var23++) {
         ...
         var1.method_22903();
         var1.method_46416(0.0F, var3.method_17682() / 2.0F, 0.0F);
         var1.method_22905(var16, var16, var16);
         var1.method_22907(class_7833.field_40718.rotationDegrees(var23 == 0 ? var9 : -var9));
         var1.method_22907(class_7833.field_40714.rotationDegrees(var23 == 0 ? var10 : -var10));
         float var25 = 0.0F;
         float var26 = -0.5F;
         float var27 = 0.0F;
         Matrix4f var28 = var1.method_23760().method_23761();
         int var29 = var12 / 2;
         ...
         for (int var30 = 0; var30 < var13; var30 += var29) {
            ...
            var6.method_22918(var28, var35, var26, var36).method_22913(var39, 0.0F).method_39415(var20);
            var6.method_22918(var28, var37, var26, var38).method_22913(var40, 0.0F).method_39415(var20);
            var6.method_22918(var28, var37, var26 + var15, var38).method_22913(var40, 0.99F).method_39415(var21);
            var6.method_22918(var28, var35, var26 + var15, var36).method_22913(var39, 0.99F).method_39415(var21);
         }
   ...
   private void renderRhomb(class_4587 var1, class_4597 var2, class_1309 var3, float var4) {
      class_4588 var5 = var2.method_73477(ClientPipelines.ROMB_ESP.apply(class_2960.method_60655("rich", "images/world/cube.png")));
      Quaternionf var6 = mc.field_1773.method_19418().method_23767();
      var1.method_46416(0.0F, var3.method_17682() / 2.0F, 0.0F);
      var1.method_22907(var6);
      float var7 = (float)(System.currentTimeMillis() % 6283L) / 1000.0F;
      var1.method_22907(class_7833.field_40718.rotationDegrees((float)Math.sin(var7) * 360.0F));
      float var8 = 0.5F;
      var1.method_22905(var8, var8, 1.0F);
      ...
      var5.method_56824(var12, var11[0].x, var11[0].y, 0.0F).method_22913(0.0F, 0.0F).method_39415(var10);
      var5.method_56824(var12, var11[1].x, var11[1].y, 0.0F).method_22913(0.0F, 1.0F).method_39415(var9);
      var5.method_56824(var12, var11[2].x, var11[2].y, 0.0F).method_22913(1.0F, 1.0F).method_39415(var10);
      var5.method_56824(var12, var11[3].x, var11[3].y, 0.0F).method_22913(1.0F, 0.0F).method_39415(var9);
   }

   private void renderGhost(class_4587 var1, class_4597 var2, class_1309 var3, float var4) {
      class_4588 var5 = var2.method_73477(ClientPipelines.GHOSTS_ESP.apply(class_2960.method_60655("rich", "images/particle/ghost-glow.png")));
      var1.method_46416(0.0F, var3.method_17682() * 0.5F, 0.0F);
      long var6 = System.currentTimeMillis() % 360000L;
      Quaternionf var8 = mc.field_1773.method_19418().method_23767();
   ...
   private void particle(class_4587 var1, class_4588 var2, TargetESP.Transformation var3, float var4, int var5, long var6, Quaternionf var8) {
      ...
      if (var15 > 0) {
         ...
         for (int var24 = 0; var24 < var15; var24++) {
            ...
            var1.method_46416(this.reusableVector.x, this.reusableVector.y, this.reusableVector.z);
            var1.method_22907(var8);
            float var32 = var20 - var24 * 10.0F;
            var1.method_22907(class_7833.field_40718.rotationDegrees(var32));
            float var33 = var24 * var21;
            float var34;
            if (var33 < 0.5F) {
               var34 = class_3532.method_16439(var33 * 2.0F, var12, var13);
            } else {
               var34 = class_3532.method_16439((var33 - 0.5F) * 2.0F, var13, var14);
            }

            int var35 = this.lerpColor(var22, var23, var33);
            var34 *= 1.0F - var33;
            int var36 = (int)(255.0F * var4);
            var1.method_46416(var34 / 2.0F, var34 / 2.0F, 0.0F);
            int var37 = this.withAlpha(var35, var36);
            class_4665 var38 = var1.method_23760();
            var2.method_56824(var38, 0.0F, -var34, 0.0F).method_22913(0.0F, 0.0F).method_39415(var37);
            var2.method_56824(var38, -var34, -var34, 0.0F).method_22913(0.0F, 1.0F).method_39415(var37);
            var2.method_56824(var38, -var34, 0.0F, 0.0F).method_22913(1.0F, 1.0F).method_39415(var37);
            var2.method_56824(var38, 0.0F, 0.0F, 0.0F).method_22913(1.0F, 0.0F).method_39415(var37);
            var1.method_22909();
         }
      }
   }

   private void createCrystals(class_1297 var1) {
      this.crystalList.clear();
      this.crystalList.add(new TargetESP.Crystal(new class_243(0.0, 2.2, 0.3), new class_243(-49.0, 0.0, 40.0)));
      this.crystalList.add(new TargetESP.Crystal(new class_243(0.3, 2.1, -0.4), new class_243(35.0, 0.0, -30.0)));
      this.crystalList.add(new TargetESP.Crystal(new class_243(-0.3, 2.3, 0.2), new class_243(-30.0, 0.0, 35.0)));
      this.crystalList.add(new TargetESP.Crystal(new class_243(0.5, 2.0, 0.5), new class_243(-25.0, 0.0, -30.0)));
      this.crystalList.add(new TargetESP.Crystal(new class_243(0.0, 1.4, 0.8), new class_243(-49.0, 0.0, 40.0)));
      this.crystalList.add(new TargetESP.Crystal(new class_243(0.2, 1.5, -0.675), new class_243(35.0, 0.0, -30.0)));
      this.crystalList.add(new TargetESP.Crystal(new class_243(0.6, 1.8, 0.6), new class_243(-30.0, 0.0, 35.0)));
      this.crystalList.add(new TargetESP.Crystal(new class_243(-0.74, 1.6, 0.4), new class_243(-25.0, 0.0, -30.0)));
      this.crystalList.add(new TargetESP.Crystal(new class_243(0.74, 1.55, -0.4), new class_243(0.0, 0.0, 0.0)));
      this.crystalList.add(new TargetESP.Crystal(new class_243(-0.475, 1.45, -0.375), new class_243(30.0, 0.0, -25.0)));
      this.crystalList.add(new TargetESP.Crystal(new class_243(0.0, 1.75, -0.6), new class_243(45.0, 0.0, 0.0)));
      this.crystalList.add(new TargetESP.Crystal(new class_243(0.85, 1.35, 0.1), new class_243(-30.0, 0.0, 30.0)));
      this.crystalList.add(new TargetESP.Crystal(new class_243(-0.7, 1.7, -0.3), new class_243(0.0, 0.0, 0.0)));
      this.crystalList.add(new TargetESP.Crystal(new class_243(-0.3, 1.65, 0.55), new class_243(0.0, 0.0, 0.0)));
      this.crystalList.add(new TargetESP.Crystal(new class_243(-0.5, 1.3, 0.7), new class_243(0.0, 0.0, 0.0)));
      this.crystalList.add(new TargetESP.Crystal(new class_243(0.5, 1.3, 0.7), new class_243(0.0, 0.0, 0.0)));
      this.crystalList.add(new TargetESP.Crystal(new class_243(-0.7, 1.4, 0.0), new class_243(0.0, 0.0, 0.0)));
      this.crystalList.add(new TargetESP.Crystal(new class_243(-0.2, 1.25, -0.7), new class_243(0.0, 0.0, 0.0)));
      this.crystalList.add(new TargetESP.Crystal(new class_243(0.2, 0.3, 0.4), new class_243(25.0, 0.0, 20.0)));
      this.crystalList.add(new TargetESP.Crystal(new class_243(-0.3, 0.2, -0.3), new class_243(-20.0, 0.0, -25.0)));
      this.crystalList.add(new TargetESP.Crystal(new class_243(0.4, 0.4, 0.2), new class_243(30.0, 0.0, 15.0)));
      this.crystalList.add(new TargetESP.Crystal(new class_243(-0.2, 0.1, 0.5), new class_243(-35.0, 0.0, 30.0)));
      this.crystalList.add(new TargetESP.Crystal(new class_243(0.3, 0.5, -0.2), new class_243(15.0, 0.0, -20.0)));
   }

   private void renderCrystals(class_4587 var1, class_4597 var2, class_1309 var3, float var4, float var5) {
      if (var3 != null && !this.crystalList.isEmpty()) {
         ...
         var1.method_22903();
         var1.method_22907(class_7833.field_40716.rotationDegrees(this.rotationAngle));
   ...
   private class Crystal {
      ...
      public Crystal(class_243 var2, class_243 var3) {
         this.position = var2;
         this.rotation = var3;
         this.rotationSpeed = 0.5F + (float)(Math.random() * 1.5);
      }

      public void render(class_4587 var1, class_4597 var2, float var3, int var4) {
         var1.method_22903();
         float var5 = TargetESP.getInstance().crystalDistance.getValue();
         var1.method_22904(this.position.field_1352 * var5, this.position.field_1351 * var5, this.position.field_1350 * var5);
         ...
         var1.method_22907(class_7833.field_40714.rotationDegrees((float)this.rotation.field_1352));
         var1.method_22907(class_7833.field_40716.rotationDegrees((float)this.rotation.field_1351 + var9));
         var1.method_22907(class_7833.field_40718.rotationDegrees((float)this.rotation.field_1350));
         float var10 = 0.4F;
         class_4588 var11 = var2.method_73477(ClientPipelines.CRYSTAL_FILLED);
         this.drawFilledCrystal(var1, var11, var4, var10 * 0.85F, var3);
         class_4588 var12 = var2.method_73477(ClientPipelines.CRYSTAL_GLOW);
         var1.method_22903();
         var1.method_22905(1.2F, 1.2F, 1.2F);
         this.drawFilledCrystal(var1, var12, var4, var10 * 0.3F, var3);
         var1.method_22909();
         var1.method_22903();
         var1.method_22905(1.3F, 1.3F, 1.3F);
         this.drawFilledCrystal(var1, var12, var4, var10 * 0.1F, var3);
         var1.method_22909();
         var1.method_22903();
         var1.method_22905(1.5F, 1.5F, 1.5F);
      ...
      private void drawFilledCrystal(class_4587 var1, class_4588 var2, int var3, float var4, float var5) {
      ...
      private void drawTriangleFilled(Matrix4f var1, class_4588 var2, Vector3f var3, Vector3f var4, Vector3f var5, int var6) {
         var2.method_22918(var1, var3.x, var3.y, var3.z).method_39415(var6);
         var2.method_22918(var1, var4.x, var4.y, var4.z).method_39415(var6);
         var2.method_22918(var1, var5.x, var5.y, var5.z).method_39415(var6);
         var2.method_22918(var1, var5.x, var5.y, var5.z).method_39415(var6);
      }

      private void drawQuadFilled(Matrix4f var1, class_4588 var2, Vector3f var3, Vector3f var4, Vector3f var5, Vector3f var6, int var7) {
         var2.method_22918(var1, var3.x, var3.y, var3.z).method_39415(var7);
         var2.method_22918(var1, var4.x, var4.y, var4.z).method_39415(var7);
         var2.method_22918(var1, var5.x, var5.y, var5.z).method_39415(var7);
         var2.method_22918(var1, var6.x, var6.y, var6.z).method_39415(var7);
      }

      private void drawBloomEffect(class_4587 var1, class_4597 var2, int var3, float var4) {
         class_4588 var5 = var2.method_73477(ClientPipelines.BLOOM_ESP.apply(class_2960.method_60655("rich", "images/particle/glow.png")));
         int var6 = (int)(18.0F * var4);
         int var7 = TargetESP.this.withAlpha(var3, var6);
         float var8 = 0.75F;
         Quaternionf var9 = IMinecraft.mc.field_1773.method_19418().method_23767();
         byte var10 = 6;

         for (int var11 = 0; var11 < var10; var11++) {
            var1.method_22903();
            float var12 = 360.0F / var10 * var11;
            var1.method_22907(class_7833.field_40716.rotationDegrees(var12));
            var1.method_22907(var9);
            Matrix4f var13 = var1.method_23760().method_23761();
            var5.method_22918(var13, -var8 / 2.0F, -var8 / 2.0F, 0.0F).method_22913(0.0F, 1.0F).method_39415(var7);
            var5.method_22918(var13, var8 / 2.0F, -var8 / 2.0F, 0.0F).method_22913(1.0F, 1.0F).method_39415(var7);
            var5.method_22918(var13, var8 / 2.0F, var8 / 2.0F, 0.0F).method_22913(1.0F, 0.0F).method_39415(var7);
            var5.method_22918(var13, -var8 / 2.0F, var8 / 2.0F, 0.0F).method_22913(0.0F, 0.0F).method_39415(var7);
            var1.method_22909();
         }
         ...
         for (int var14 = 0; var14 < var10; var14++) {
            ...
            var1.method_22907(class_7833.field_40716.rotationDegrees(var15));
            var1.method_22907(var9);
            Matrix4f var16 = var1.method_23760().method_23761();
            var5.method_22918(var16, -var8 / 2.0F, -var8 / 2.0F, 0.0F).method_22913(0.0F, 1.0F).method_39415(var7);
            var5.method_22918(var16, var8 / 2.0F, -var8 / 2.0F, 0.0F).method_22913(1.0F, 1.0F).method_39415(var7);
            var5.method_22918(var16, var8 / 2.0F, var8 / 2.0F, 0.0F).method_22913(1.0F, 0.0F).method_39415(var7);
            var5.method_22918(var16, -var8 / 2.0F, var8 / 2.0F, 0.0F).method_22913(0.0F, 0.0F).method_39415(var7);
            var1.method_22909();
         }
      }
