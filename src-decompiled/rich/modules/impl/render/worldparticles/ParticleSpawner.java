...
public class ParticleSpawner {
   ...
   public static Particle createParticle(class_243 var0, class_243 var1, double var2, long var4, Particle.ParticleType var6) {
      double var7 = 3.0 + Math.random() * 57.0;
      double var9 = Math.random() * Math.PI * 2.0;
      double var11 = var0.field_1352;
      double var13 = var0.field_1350;
      if (var2 > 0.05 && var1.method_37267() > 0.01) {
         class_243 var15 = var1.method_1029();
         double var16 = Math.atan2(var15.field_1350, var15.field_1352);
         double var18 = Math.PI * 2.0 / 5.0;
         var9 = var16 + (Math.random() - 0.5) * var18 * 2.0;
         double var20 = var7 * 0.7 * Math.min(var2 * 8.0, 1.0);
         var11 += var15.field_1352 * var20;
         var13 += var15.field_1350 * var20;
      }

      double var27 = var11 + Math.cos(var9) * var7;
      double var17 = var13 + Math.sin(var9) * var7;
      double var19 = var0.field_1351 - 5.0 + Math.random() * 25.0;
   ...
   public static Particle createParticle(class_243 var0, class_243 var1, double var2, long var4) {
