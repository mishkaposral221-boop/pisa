...
public class CameraSettings extends ModuleStructure {
   ...
   public void onKey(KeyEvent var1) {
      if (var1.isKeyDown(this.zoomSetting.getKey())) {
         this.fov = Math.min(this.lastChangedFov, (Integer)mc.field_1690.method_41808().method_41753() - 20);
      }
   ...
   public void onHotBarScroll(HotBarScrollEvent var1) {
      if (PlayerInteractionHelper.isKey(this.zoomSetting)) {
         this.fov = (int)class_3532.method_15350(this.fov - var1.getVertical() * 10.0, 10.0, ((Integer)mc.field_1690.method_41808().method_41753()).intValue());
         var1.cancel();
      }
   }
