...
public class ItemParser extends ModuleStructure {
   ...
   public void parseAllSlots(List<class_1735> var1, int var2, String var3) {
      this.parseCounter++;
      ...
      for (int var7 = 0; var7 < var2 && var7 < var1.size(); var7++) {
         class_1735 var8 = (class_1735)var1.get(var7);
         class_1799 var9 = var8.method_7677();
         if (!var9.method_7960()) {
            String var10 = class_7923.field_41178.method_10221(var9.method_7909()).toString();
   ...
   private void parseItemCompact(class_1799 var1, StringBuilder var2) {
      String var3 = class_7923.field_41178.method_10221(var1.method_7909()).toString();
      class_2561 var4 = (class_2561)var1.method_58694(class_9334.field_49631);
      String var5 = var4 != null ? var4.getString() : var1.method_7964().getString();
      ...
      if (var6 != null && !var6.comp_2400().isEmpty()) {
         ...
         for (int var7 = 0; var7 < var6.comp_2400().size(); var7++) {
            String var8 = ((class_2561)var6.comp_2400().get(var7)).getString();
            if (!var8.trim().isEmpty()) {
               var2.append("    Text.literal(\"").append(this.escapeString(var8)).append("\")");
               if (var7 < var6.comp_2400().size() - 1) {
                  var2.append(",");
               }
      ...
      if (var1.method_7909() == class_1802.field_8575) {
         this.generateHeadCode(var1, var5, var2);
      } else if (var1.method_7909() == class_1802.field_8288) {
         this.generateTalismanCode(var5, var2);
      } else if (var1.method_7909() != class_1802.field_8574 && var1.method_7909() != class_1802.field_8436 && var1.method_7909() != class_1802.field_8150) {
   ...
   private void generateHeadCode(class_1799 var1, String var2, StringBuilder var3) {
      class_9296 var4 = (class_9296)var1.method_58694(class_9334.field_49617);
      if (var4 == null) {
         var3.append("// НЕТ ПРОФИЛЯ\n");
      } else {
         GameProfile var5 = var4.method_73313();
   ...
   private void generatePotionCode(class_1799 var1, String var2, StringBuilder var3) {
      String var4;
      if (var1.method_7909() == class_1802.field_8436) {
         var4 = "SPLASH_POTION";
      } else if (var1.method_7909() == class_1802.field_8150) {
         var4 = "LINGERING_POTION";
      } else {
         var4 = "POTION";
      }

      class_1844 var5 = (class_1844)var1.method_58694(class_9334.field_49651);
      if (var5 != null) {
         ArrayList var6 = new ArrayList();

         for (class_1293 var8 : var5.method_57397()) {
            var6.add(var8);
         }

         int var16 = var5.method_8064();
         ...
         if (!var6.isEmpty()) {
            ...
            for (int var9 = 0; var9 < var6.size(); var9++) {
               class_1293 var10 = (class_1293)var6.get(var9);
               String var11 = var10.method_5579().method_55840();
               if (var11 != null) {
                  var11 = var11.replace("minecraft:", "");
               }

               String var12 = EFFECT_TO_STATUSEFFECTS.getOrDefault(var11, "StatusEffects." + var11.toUpperCase());
               int var13 = var10.method_5584();
               int var14 = var10.method_5578();
   ...
   private void generateGenericCode(class_1799 var1, String var2, StringBuilder var3) {
      String var4 = class_7923.field_41178.method_10221(var1.method_7909()).method_12832().toUpperCase();
   ...
   private void saveToFile(String var1, int var2) {
      try {
         ...
         File var4 = new File(var3.field_1697, "item_parser");
         if (!var4.exists()) {
            var4.mkdirs();
         }
