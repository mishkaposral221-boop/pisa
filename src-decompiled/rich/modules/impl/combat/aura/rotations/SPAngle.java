...
public class SPAngle extends RotateConstructor {
   ...
   public Angle limitAngleChange(Angle var1, Angle var2, class_243 var3, class_1297 var4) {
      ...
      if (var4 != null && var8) {
         class_243 var9 = Vector.hitbox(var4, 1.0F, var4.method_24828() ? 1.0F : 1.256F, 1.0F, 2.0F);
      ...
      boolean var13 = false;
      if (var4 != null && !var8) {
         var13 = RaycastAngle.rayTrace(AngleConnection.INSTANCE.getRotation().toVector(), 4.0, var4.method_5829());
      }
      ...
      if (var8) {
         ...
         float var23 = class_3532.method_15363(var12 / 30.0F, 0.1F, 1.0F);
      ...
      float var25 = class_3532.method_15363(var10, -var32, var32);
      float var26 = class_3532.method_15363(var11, -var24, var24);
      ...
      float var29 = class_3532.method_16439(this.currentSpeed, var1.getYaw(), var1.getYaw() + var25) + var27;
      float var30 = class_3532.method_16439(this.currentSpeed, var1.getPitch(), var1.getPitch() + var26) + var28;
      return new Angle(var29, class_3532.method_15363(var30, -90.0F, 90.0F));
   }
