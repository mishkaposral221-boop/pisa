...
public class MatrixAngle extends RotateConstructor {
   ...
   public Angle limitAngleChange(Angle var1, Angle var2, class_243 var3, class_1297 var4) {
      ...
      if (var4 != null && var7) {
         class_243 var8 = Vector.hitbox(var4, 1.0F, var4.method_24828() ? 0.9F : 1.4F, 1.0F, 2.0F);
      ...
      boolean var12 = false;
      if (var4 != null && !var7 && RaycastAngle.rayTrace(AngleConnection.INSTANCE.getRotation().toVector(), 4.0, var4.method_5829())) {
         var12 = true;
      }
      ...
      if (!var7 || var4 == null) {
         float var22 = class_3532.method_15363(1.0F - var11 / 180.0F, 0.1F, 1.0F);
      ...
      float var26 = class_3532.method_15363(var9, -var16, var16) + var20;
      float var23 = class_3532.method_15363(var10, -var17, var17) + var21;
      Angle var24 = new Angle(var1.getYaw(), var1.getPitch());
      var24.setYaw(class_3532.method_16439(this.randomLerp(var15, var15), var1.getYaw(), var1.getYaw() + var26) + var18);
      var24.setPitch(class_3532.method_16439(this.randomLerp(var15, var15), var1.getPitch(), var1.getPitch() + var23) + var19);
      return var24;
   }
