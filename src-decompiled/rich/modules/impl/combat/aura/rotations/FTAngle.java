...
public class FTAngle extends RotateConstructor {
   ...
   public Angle limitAngleChange(Angle var1, Angle var2, class_243 var3, class_1297 var4) {
      ...
      if (var4 != null) {
         ...
         float var32 = class_3532.method_15363(var11, -var30, var30);
         float var33 = class_3532.method_15363(var12, -var31, var31);
         float var34 = this.randomLerp(var29, var29 + 0.6F);
         float var35 = class_3532.method_16439(var34, var1.getYaw(), var1.getYaw() + var32) + this.currentJitterYaw;
         float var36 = class_3532.method_16439(var34, var1.getPitch(), var1.getPitch() + var33) + this.currentJitterPitch;
         return new Angle(var35, class_3532.method_15363(var36, -90.0F, 90.0F));
      } else {
         ...
         float var23 = class_3532.method_15363(var11, -var21, var21);
         float var24 = class_3532.method_15363(var12, -var22, var22);
         float var25 = Math.clamp(this.randomLerp(var18, var18 + 0.2F), 0.0F, 1.0F);
         float var26 = class_3532.method_16439(var25, var1.getYaw(), var1.getYaw() + var23) + var19;
         float var27 = class_3532.method_16439(var25, var1.getPitch(), var1.getPitch() + var24) + var20;
         return new Angle(var26, class_3532.method_15363(var27, -90.0F, 90.0F));
      }
   }
